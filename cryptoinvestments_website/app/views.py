...
def eos():
    ...
    turn_prices_to_graph('EOS', 90, 1,'app/static/eos.png')
...
def counterparty():
    ...
    turn_prices_to_graph('XCP', 90, 1,'app/static/counterparty.png')
...
def neoscoin():
    ...
    turn_prices_to_graph('NEOS', 90, 1,'app/static/neoscoin.png')
...
def monero():
    ...
    turn_prices_to_graph('XMR', 90, 1,'app/static/monero.png')
...
def lisk():
    ...
    turn_prices_to_graph('LSK', 90, 1,'app/static/lisk.png')
...
def golem():
    ...
    turn_prices_to_graph('GNT', 90, 1,'app/static/golem.png')
...
def waves():
    ...
    turn_prices_to_graph('WAVES', 90, 1,'app/static/waves.png')
...
def status():
    ...
    turn_prices_to_graph('SNT', 90, 1,'app/static/status.png')
...
def stratis():
    ...
    turn_prices_to_graph('STRAT', 90, 1,'app/static/stratis.png')
...
def vertcoin():
    ...
    turn_prices_to_graph('VTC', 90, 1,'app/static/vertcoin.png')
...
def verge():
    ...
    turn_prices_to_graph('XVG', 90, 1,'app/static/verge.png')
...
def dogecoin():
    ...
    turn_prices_to_graph('DOGE', 90, 1,'app/static/dogecoin.png')
...
def siacoin():
    ...
    turn_prices_to_graph('SC', 90, 1,'app/static/siacoin.png')
...
def cardano():
    ...
    turn_prices_to_graph('ADA', 90, 1,'app/static/cardano.png')
...
def steem_dollars():
    ...
    turn_prices_to_graph('SBD', 90, 1,'app/static/steem_dollars.png')
...
def bitshares():
    ...
    turn_prices_to_graph('BTS', 90, 1,'app/static/bitshares.png')
...
def gas():
    ...
    turn_prices_to_graph('GAS', 90, 1,'app/static/gas.png')
...
def augur():
    ...
    turn_prices_to_graph('REP', 90, 1,'app/static/augur.png')
...
def stellar_lumens():
    ...
    turn_prices_to_graph('XLM', 90, 1,'app/static/stellar_lumens.png')
...
def factom():
    ...
    turn_prices_to_graph('FCT', 90, 1,'app/static/factom.png')
...
def nem():
    ...
    turn_prices_to_graph('XEM', 90, 1,'app/static/nem.png')
...
def steem():
    ...
    turn_prices_to_graph('STEEM', 90, 1,'app/static/steem.png')
...
def pivx():
    ...
    turn_prices_to_graph('PIVX', 90, 1,'app/static/pivx.png')
...
def storj():
    ...
    turn_prices_to_graph('STORJ', 90, 1,'app/static/storj.png')
...
def decred():
    ...
    turn_prices_to_graph('DCR', 90, 1,'app/static/decred.png')
...
def zcoin():
    ...
    turn_prices_to_graph('XZC', 90, 1,'app/static/zcoin.png')
...
def syscoin():
    ...
    turn_prices_to_graph('SYS', 90, 1,'app/static/syscoin.png')
...
def maidsafecoin():
    ...
    turn_prices_to_graph('MAID', 90, 1,'app/static/maidsafecoin.png')
